...
const allMorphingPaths = [];
  const infoBoxes = [
    ...
    //#
      ...
      { 
        title: "BATTERY LIGHT",
        text: "A battery indicator light keeps you informed about your battery status, ensuring you're never caught off guard by a low battery while on the go.",
        image: "images/copperinsulation.jpg"
      },
      //#
          //#green
    { 
      ...
      text: "The touch-sensitive controls allow you to adjust the volume effortlessly by simply tapping or swiping on the earbuds, giving you complete control over your audio experience.",
      image: "images/copperinsulation.jpg"
    },
    //#
        //#white
  ...
  hotspotHovers.forEach(hotspotHover => {
    ...
    allMorphingPaths.push(morphingPaths);
      ...
      var tl = new TimelineMax({Delay:0.3});
          tl.to(morphingPaths, .6, {morphSVG:toPath})
        });
          
        hotspotHover.addEventListener("mouseout", () => {
          var tl2 = new TimelineMax({Delay:0.3});
          tl2.to(morphingPaths, .6, {morphSVG:fromPath})
        });      
      });
